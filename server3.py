...
def initiate_resync():
    ...
    resyncdata.data = server3_data
    resyncdata.length = len(resyncdata.data)
    resyncdata.sentfrom = "server3"
    ...
    while True:
        ...
        if resultpickled.packettype == RESYNCRONIZE:
            ...
            for tempdata in resultpickled.data :
                for serverdata in server3_data :
